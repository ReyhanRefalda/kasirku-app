        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p><strong>Tipe Pengguna Saat Transaksi:</strong> {{ $penjualan->tipe_pengguna_transaksi ?? '-' }}</p>
                ...
                <div class="col-md-6">
                    ...
                    <p><strong>Diskon:</strong> {{ $penjualan->diskon_persen ?? 0 }}%
                        (Rp {{ number_format(($penjualan->total_pembelanjaan * ($penjualan->diskon_persen ?? 0)) / 100, 2) }})
                    </p>
                    ...
                    <p><strong>Sisa Poin Pengguna:</strong> {{ number_format($penjualan->pengguna->membership_poin ?? 0) }} poin</p>
                    ...
                    <p><strong>Total Setelah Diskon, Poin & PPN:</strong> Rp {{ number_format($penjualan->total_akhir, 2) }}</p>
            ...
            <!-- Subtotal akhir yang sudah disesuaikan -->
            <p><strong>Total Setelah Diskon, Poin & PPN:</strong> Rp {{ number_format($penjualan->total_akhir, 2) }}</p>

            <a href="{{ route('laporan.cetak_pdf', $penjualan->id) }}" class="btn btn-danger">Cetak PDF</a>
        </div>
    </div>
